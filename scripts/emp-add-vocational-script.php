...
if(isset($_POST['btn_save']))
{
	...
	if($err_count<1)
	{
	 ...
	 $sql = "insert into emp_education_vocational (agencyid,school,course,from_year,to_year,graduate,units,scholarship,void) values (?,?,?,?,?,?,?,?,?)";
	 $params= array($uid,$txt_school,$txt_course,$txt_from,$txt_to,$radio_grad,$txt_units,$txt_scholarship,"1");

	 sqlsrv_query($conn,$sql,$params);

	 include "scripts/audit_emp_add_vocational.php";
