...
if(isset($_POST["basicsave"])) 
{
  ...
  if( $source != "" )
  {
    ...
    $basic_add_sql = "INSERT INTO employee_basic(imagepath, agencyid, surname, suffix, firstname, middlename, dob, pob, gender, civil, citizenship, multi,  height, weight, bloodtype, username, password, userlevel, hrinfo, misc_info, address) VALUES('$destination', '$agencyid', '$surname', '$suffix', '$firstname', '$middlename', '$dob', '$pob', '$radiogender', '$radiocivil', '$radiodual', '$cid', '$height', '$weight', '$bloodtype', '$userlevel', '$hrinfo',  '$miscinfo', '$address')";

    $account_sql = "INSERT INTO user_accounts(agencyid, username, pass) VALUES ('$agencyid','$username','$password')";
    ...
    echo "<br><a href='addemp.php' class='btn btn-success'>Stay at current form?</a><br>";
    }
  }
