...
//find audit action: login
                ...
                $action_details='Create Account'; // action details
                $affected_record = "Basic Information"; // affected record

                $get_record_id = "select * from emp_basic where agencyid='$agencyid'";
