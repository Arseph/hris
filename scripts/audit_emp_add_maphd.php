<?php
                ...
                $affected_record = "Master/Doctorate Level Education"; // affected record

                $get_record_id = "select * from emp_education_maphd where agencyid='$uid' order by id desc";
                ...
                $audit_action_params = array("$current_user","$action_date","$action_time","6","$action_details", "$affected_record", $record_id);
