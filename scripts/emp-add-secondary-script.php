...
if(isset($_POST['btn_save']))
{
	...
	$radio_grad=$_POST['radio_grad'];
		...
		$find_dupe_sql = "select * from emp_education_secondary where agencyid='$uid' and graduate='1' and void='1'";
		$params = array();
	...
	if($count_row==0)
	{
	 ...
	 $sql = "insert into emp_education_secondary (agencyid,school,from_year,to_year,scholarship,graduate,void) values (?,?,?,?,?,?,?)";
	 $params= array($uid,$txt_school,$txt_from,$txt_to,$txt_scholarship,$radio_grad,"1");

	 sqlsrv_query($conn,$sql,$params);

	 include "scripts/audit_emp_add_secondary.php";
