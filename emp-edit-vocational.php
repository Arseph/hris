...
$getdata_sql = "select * from emp_education_vocational where id='$id' and agencyid='$uid'";
...
<style type="text/css">
  ...
  <form method="post">
    <div class="pagetitle">
      <h1>Update Vocational Level Education</h1>
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Update Vocational Level Education</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    <section class="section">
      <div class="row">
        <div class="col-lg-7">
         <form method="post">
         <?php include "scripts/emp-edit-vocational-script.php"; ?> 
         <div class="card">
            <div class="card-body">
            <br>
              <b>School Name:</b><br>
