                     ...
                     <?php 
                      ...
                      $row_count = sqlsrv_num_rows( $stmt );
                        ...
                        if($row_count>0)
                        {
                          ...
                          {
                            echo '<input type="text" class="form-control" value="'.$row['child_name'].'" id="c_name" name="c_name[]">';
                          }
                        }
                      ?>
                  </div>
                  <div class="col-sm-4" id='bdaydiv'>
                      ...
                      $row_count = sqlsrv_num_rows( $stmt );
                        ...
                        if($row_count>0)
                        {
                          ...
                          while($row = sqlsrv_fetch_array($stmt))
                          {
                            echo '<input type="date" class="form-control" value="'.$row['bday'].'" id="c_bday" name="c_bday[]">';
                          }
                        }
                      ?>
                  </div>
 ...
 <?php
  ...
  <script src="assets/js/main.js"></script>
    ...
    function minusChild() {
      ...
      if(c_length.childNodes.length > 1) 
      {
