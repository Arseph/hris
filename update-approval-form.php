...
// $leavedata_sql = "select * from emp_leave where agencyid='$uid' and file_id='$file_id' and record_version='$record_version'";

$leavedata_sql = "select * from emp_leave where agencyid='$uid' and leave_id='$file_id'";

$result1 = sqlsrv_query($conn, $leavedata_sql);
$row1 = sqlsrv_fetch_array($result1);
$file_date=$row1['file_date'];


$db_leave_id=$row1['leave_id'];
$place=$row1['place'];

$inoutph=$row1['inout_ph'];

$days_applied=$row1['days_applied'];
    ...
    <div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="admin-leave-list.php">Leave List</a></li>
    ...
    <section class="section">
      ...
      <div class="row">
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
              <h3 class="card-title"><b>Update Leave Approval Form</b></h3>
