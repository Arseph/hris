        ...
        <div class="col-xl-4">
          ...
          <div class="card">
              ...
              <div class="card-body">
                ...
                <h4>Identified <strong><code>6 Missing</code></strong> and <strong><code>8 potential outdated</code> </strong> Data <br></h4> 
                <p>Basic Information, Address, Identification, Family Information, Misc Information, Designation, Education History, Eligibility</p>
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-change-password">Identification</button>
                </li>
