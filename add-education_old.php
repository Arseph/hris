  ...
  <script>
    ...
    function addP() {
        ...
        psto.setAttribute('required', '');
         ...
         const pgrad = document.createElement("input");
        document.getElementById("psytodiv").appendChild(pgrad);
        pgrad.setAttribute('id','pgrad_year'+p)
        pgrad.setAttribute('name','pgrad_year');
        pgrad.setAttribute('type','radio');
        pgrad.setAttribute('value',radio2);
        ...
        // const phighest = document.createElement("input");
        // document.getElementById("phighdiv").appendChild(phighest);
        // phighest.setAttribute('id','txt_phighest'+p);
        // phighest.setAttribute('name','txt_phighest[]');
        // phighest.setAttribute('class','txt_to');
        // phighest.setAttribute('type','text');
        // phighest.setAttribute('placeholder', 'Highest level');
        // phighest.setAttribute('style', 'width:100%');
    ...
    function  addS(){
        ...
        ssto.setAttribute('style', 'width:50%');

        const sgrad = document.createElement("input");
        document.getElementById("ssytodiv").appendChild(sgrad);
        sgrad.setAttribute('id','sgrad_year'+s)
        sgrad.setAttribute('name','sgrad_year');
        sgrad.setAttribute('type','radio');
        sgrad.setAttribute('value',radio);

        const newLabel = document.createElement("label");
        newLabel.innerHTML = " Graduate year? ";
        document.getElementById("ssytodiv").appendChild(newLabel);
    ...
    function addT(){
      ...
      const tcourse = document.createElement("input");
        ...
        tcourse.setAttribute('id','tschool'+t);
        ...
        // units.setAttribute('disabled','true');
              ...
              <div  class="row g-3">
                ...
                <br>
                 <div id='primary_main' class="row g-3">
                    ...
                    <div class="col-md-3" id='pschooldiv'>
                    ...
                    <div class="col-md-3" id='psytodiv'>
                      <input type="number" class="txt_to" placeholder="Year (To)" name='psyto[]' required id='psyto0' style='width:50%;'>
                      <input type="radio" id="pgrad_year0" name="pgrad_year" value='0'><label>Graduate year?</label> 

                    </div >
                    <div class="col-md-2">
                     <div class="input-group mb-3"  id='phighdiv'>
                        <!-- <input type="text" id='txt_phighest0' class="txt_to" placeholder="Highest level" name="txt_phighest" style='width:100%'> -->
                        <select class="form-select" name="sel_primary" required>
                    <option value='0'>- Select -</option>
                    <?php 
                    $primary_sql = "select * from dbo.select_highest_edu where edu_level = 'primary'";
                    ...
                    <div class="col-md-2" id='pscholardiv'>
                      <input type="text" 
                      class="form-control"
                ...
                <div id='secondary_main' class="row g-3">
                    ...
                    <div class="col-md-3" id='sschooldiv'>
                      <input type="text" class="form-control" placeholder="Name of School" name='sschool[]' required>
                    </div>
                    

                    <div class="col-md-2" id='ssyfromdiv'>
                      <input type="number" class="form-control" placeholder="Year (From)" name='ssyfrom[]' required>
  
                    </div>

                    <div class="col-md-3" id='ssytodiv'>
                      <input type="number" class="txt_to" placeholder="Year (To)" name='ssyto[]' required id='ssto0' style='width:50%;'>
                      <input type="radio" id="sgrad_year0" name="sgrad_year" value='0'><label>Graduate year?</label> 

                    </div >

                    <div class="col-md-2">
                     <div class="input-group mb-3"  id='shighdiv'>
                        <!-- <input type="text" id='txt_shighest0' class="form-control" placeholder="Highest level" name="txt_shighest" style='width:100%;'> -->
                             <select class="form-select" name="sel_secondary" required>
                    <option value='0'>- Select -</option>
                    <?php 
                    $secondary_sql = "select * from dbo.select_highest_edu where edu_level = 'secondary'";
                    ...
                    <div class="col-md-2" id='sscholardiv'>
                      <input type="text" 
                      class="form-control"
                ...
                <div id='tertiary_main' class="row g-3">
                    ...
                    <div class="col-md-2" id='tschooldiv'>
                      <input type="text" class="form-control" placeholder="Name of School" name='tschool[]' required>
                    </div>

                    <div class="col-md-2" id='coursediv'>
                      <input type="text" name="course[]" placeholder="Degree/Course" class="
                      form-control" required>
                    </div>

                    <div class="col-md-2" id='tsyfromdiv'>
                      <input type="number" class="form-control" placeholder="Year (From)" name='tsyfrom[]' required>
                    </div>

                    <div class="col-md-3" id='tsytodiv'>
                      <input type="number" class="txt_to" placeholder="Year (To)" name='tsyto[]' required id='tsto0' style='width:50%;'>
