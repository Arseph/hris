...
<?php
                    ...
                    while($get_all_rows = sqlsrv_fetch_array($get_all_stmt))
                    {
                      ...
                      $surname= $get_all_rows['surname'];
                      $fname = $get_all_rows['firstname'];
                      $mname = $get_all_rows['middlename'];

                      //get all basic info
                      $getbasic_sql = "select TOP 1 * from emp_designation where agencyid='$agencyid' and status='1' and exit_date='To Present' order by id desc";
