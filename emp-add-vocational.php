...
<style type="text/css">
  ...
  <form method="post">
    <div class="pagetitle">
      <h1>Add Vocational Degree Level Education</h1>
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Add New Vocational Level Education</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    <section class="section">
      <div class="row">
        <div class="col-lg-7">
         <form method="post">
         <?php include "scripts/emp-add-vocational-script.php"; ?> 
         <div class="card">
            <div class="card-body">
            <br>
              <b>School Name:</b><br>
              <input type='text' name='txt_school' class='form-control' placeholder='e.g. Sta. Cruz Technical and Vocational School Inc.' value='<?php
              ...
              <br>
              <b>Course:</b><br>
              <input type='text' name='txt_course' class='form-control' placeholder='e.g. Mechanic' value='<?php
