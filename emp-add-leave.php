        ...
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <?php include "scripts/emp-add-leave-script.php"; ?>
              ...
              <form method="post" type="submit">
                ...
                <div>
                  ...
                  <input type='date' class='form-control' name='dof' <?php if(isset($_POST['dof'])){echo $_POST['dof'];}?>required>
                </div>
                <br>
                <div>
                ...
                <div>
                  ...
                  <?php 
                  if((isset($_POST['inout_ph']))&&($_POST['inout_ph']=='0'))
                    { echo "checked"; } 
                  ?>
                   required>Within Philippines<br>
                  <input type='radio' name='inout_ph' value='1'<?php 
                  if((isset($_POST['inout_ph']))&&($_POST['inout_ph']=='1'))
                    { echo "checked"; } 
                  ?>>Abroad
                  <input type='text' class='form-control' name='place' placeholder="Enter Location" value='<?php if(isset($_POST['place'])){ echo $_POST['place']; }?>' required>
                </div>

                <div id='sick_leave' class='hide_element'>
                  <h5 class="card-title"><b>Sick Leave Details</b></h5>
                  <span><input type='radio' name='yesno_hospital' id='yesno_hospital' value='0' <?php if((isset($_POST['yesno_hospital']))&&($_POST['yesno_hospital']==0)){ echo "checked"; }?>>In Hospital</span>
                  <span><input type='radio' name='yesno_hospital' value='1'  <?php if((isset($_POST['yesno_hospital']))&&($_POST['yesno_hospital']==1)){ echo "checked"; }?>>Out Patient</span><br>
                  <input type='text' class='form-control' name='sick_illness' id='sick_illness' placeholder="Specify Illness" value='<?php if(isset($_POST['sick_illness'])){ echo $_POST['sick_illness']; }?>'>
                </div>
                ...
                <div>
                  ...
                  <input type="number" class="form-control" name="days_applied" value='<?php if(isset($_POST['days_applied'])){ echo $_POST['days_applied']; }?>' required><br>
                ...
                <div>
                  <b>Commutation</b><br>
                  <input type="radio" name='yesno_commutation' value='0' required>Not Requested<br>
                  <input type="radio" name='yesno_commutation' value='1'>Requested
                </div>
                <div class="row mb-3">
