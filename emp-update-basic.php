...
$sql = "select top 1 * from emp_basic where agencyid='$uid' order by id";
  ...
  <main id="main" class="main">
    ...
    onfocus="if (this.value == '') {this.value = '';}">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input  required type="text" class="form-control" name="username"  value="<?php echo $username; ?>">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input  required type="password" class="form-control" name="retype" value="<?php echo $password; ?>">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    ...
                    include "scripts\connect.php";
                    $sql_empname = "select level_name,level from dbo.select_userlevel where  level > '2'";
