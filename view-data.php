            ...
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
               ...
               if($imagepath!="")
                { 
                  ...
                  //echo "<img src='uploads/pic.jpg'>";
                } 
                else 
                { 
                  echo '<img src="assets/img/personel-logo.jpg" alt="Profile">'; 
                }
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#taddress">Test Address</button>
                </li>
              ...
              <div class="tab-content pt-2">
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $userlevel; ?></div>
                  </div>
                ...
                <div class="tab-pane fade address pt-3" id="address">
                  <!-- Profile Edit Form -->
                  <div class="tab-pane fade show active profile-overview" id="address">
<h5 class="card-title">Profile Details</h5>
