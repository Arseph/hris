            ...
            <div class="card-body">
              ...
              <form action="" method="post"  enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-8" >
                    <input class="form-control" type="file" id="imagepath" name="imagepath" disabled>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-8">
                    <input class="form-control" type="file" id="imagepath" name="coc" disabled>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-8">
                    <input disabled type="text" class="form-control" name="title" value="<?php echo $title; ?>">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div required class="col-sm-8">
                    <input type="date" class="form-control" name="from_date" value="<?php echo $from_date; ?>" disabled>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-8">
                    <input type="date" class="form-control" name="to_date" value="<?php echo $to_date; ?>" disabled>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-8">
                    <input type='number' name='hours' class='form-control' value="<?php echo $hours; ?>" disabled>
                  </div>
                ...
                <div class="row mb-3">
                  ...
                  <div required class="col-sm-8">
                    <select name='sel_ldtype' class='form-control' disabled>
                ...
                <div class="row mb-3">
                  ...
                  <div required class="col-sm-8">
                    <textarea name='txt_conduct' class='form-control' disabled><?php echo $sponsor; ?> </textarea>
                  </div>
                  <br><br><br>
