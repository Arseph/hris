         ...
         <div class="card">
            ...
            ?>
                ...
                <div class="col-md-6">
                    ...
                    <input required type="radio" name="eligible" Value="yes" onchange="notElig()" 
                    <?php 
                    ...
                    ?>
                    >Yes
                    <input required type="radio" name="eligible" Value="no" onchange="elig()" 
                    <?php 
                ...
                <div class="col-6">
                 ...
                 <select class="form-select" name="lvl3" id='elig_lvl3'>
                   <option value='0'>- Select -</option>
                   <?php
