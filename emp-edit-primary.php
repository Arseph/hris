...
$find_sql = "select * from emp_education_primary where agencyid='$uid' and id='$id'";
...
<style type="text/css">
  ...
  <form method="post">
    <div class="pagetitle">
      <h1>Update Primary Level Education</h1>
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Update Primary Level Education</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    <section class="section">
      <div class="row">
        <div class="col-lg-7">
         <form method="post">
         <?php include "scripts/emp-edit-primary-script.php"; ?> 
         <div class="card">
            <div class="card-body">
            <br>
              <b>School Name:</b><br>
