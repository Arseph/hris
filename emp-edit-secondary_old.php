...
$find_sql = "select * from emp_education_secondary where agencyid='$uid' and record_version='$emp_record_version' and file_id='$emp_file_id'";
...
<style type="text/css">
  ...
  <form method="post">
    <div class="pagetitle">
      <h1>Add Secondary Level Education</h1>
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Add New Secondary Education</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
