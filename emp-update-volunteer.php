...
$getdata_sql = "select * from emp_volunteer where id='$id'";
$data_stmt = sqlsrv_query($conn, $getdata_sql);

$data_row = sqlsrv_fetch_array($data_stmt);

$org_name =  $data_row['org_name'];
$from =  $data_row['from_date'];
$to =  $data_row['to_date'];
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <?php
                include "scripts/emp-update-volunteer-script.php";
              ?>
              ...
              <form action="" method="post"  enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  <label for="surname" class="col-sm-4 col-form-label">NAME & ADDRESS OF ORGANIZATION<br><b>(Write in full)</b></label>
                  <div class="col-sm-8">
                    <input required type="text" class="form-control" name="txt_name" value="<?php echo $org_name; ?>">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div required class="col-sm-8">
                    <input type="date" class="form-control" name="from_date" value="<?php echo $from; ?>" required>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-8">
                    <input type="date" class="form-control" name="to_date" value="<?php echo $to; ?>" required>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <label for="dob" class="col-sm-4 col-form-label">Position/Nature of Work</label>

                  <div required class="col-sm-8">
                    <textarea name='txt_position' class='form-control' required><?php echo $position; ?> </textarea>
                  </div>
                  <br><br><br>
