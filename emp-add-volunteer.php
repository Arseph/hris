        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <?php
                include "scripts/emp-add-volunteer-script.php";
              ?>
              ...
              <form action="" method="post"  enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-8">
                    <input required type="text" class="form-control" name="txt_name" value="<?php if(isset($_POST['txt_name'])){ echo $_POST['txt_name']; }?>">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div required class="col-sm-8">
                    <textarea name='txt_position' class='form-control' required><?php if(isset($_POST['txt_position'])){ echo $_POST['txt_position']; }?> </textarea>
                  </div>
                  <br><br><br>
